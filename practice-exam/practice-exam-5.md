...
28. A user has opened a "Production System Down" support case to get help from AWS Support after a production system disruption. What is the expected response time for this type of support case?
    ...
    - For a "Production System Down" case, which corresponds to a Severity Level 1 (Sev1) issue in the Business or Enterprise Support Plan, AWS Support commits to a 15-minute response time.
    - For a Critical (Production System Down) severity level, Response time is 15mins
    - For an Urgent (Production System Impaired but not fully down) severity level, Response time is 1hour
    - For a High (System Impaired) severity level, Response time is 4hours
    - For a Normal(General Guidance) level, Response time is 12- 24hour
    </details>
